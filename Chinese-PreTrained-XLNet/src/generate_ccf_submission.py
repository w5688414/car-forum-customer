...
# predict_file='/media/data/checkpoints/xlnet_output/carforum.tsv'
predict_file='/media/data/checkpoints/xlnet_output_base/carforum.tsv'
pred_data=pd.read_csv(predict_file,sep='\t')
pred_data.rename(columns={"prediction":"label"},inplace=True)
# pred_data.head()
